...
ROOT_URLCONF = 'sklep_studia.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # <-- to jest kluczowe!
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'staticfiles')]  # katalog na pliki źródłowe

STATIC_ROOT = os.path.join(BASE_DIR, 'static')  # katalog docelowy przy collectstatic
